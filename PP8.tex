...
float FullScale=5.;
float f = 80;
int T = int (1000000./(float)(f*NSamples));
int i = 0;
long unsigned t0,t1,t;
...
void loop() {
  ...
  for(i=0;i<NSamples;i++){
    ...
    Serial.print(" ");
    //Serial.print(" V = ");
    float temp = float (data[i])/1023*FullScale;
    Serial.println(temp);
  }
  delay(1000);
  while(1){ }
